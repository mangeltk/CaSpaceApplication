...
import com.example.caspaceapplication.messaging.adapters.MessagingRecentConversationsAdapter;
...
public class MessagingMainActivity extends MessagingBaseActivity implements ConversationListener {

    private ActivityMessagingMainBinding binding;
    private PreferenceManager preferenceManager;
    private List<ChatMessage> conversations;
    private MessagingRecentConversationsAdapter conversationsAdapter;
    ...
    private void init()
    {
        ...
        conversationsAdapter = new MessagingRecentConversationsAdapter(conversations, this);
    ...
    private void setListeners() {
        ...
        binding.fabNewChat.setOnClickListener(v ->
                startActivity(new Intent(getApplicationContext(), MessagingUsersActivity.class)));
    }

    private void loadUserDetails() {
        binding.textFirstName.setText(preferenceManager.getString(Constants.KEY_FIRST_NAME));
    ...
    private void signOut()
    {
        ...
        FirebaseFirestore database = FirebaseFirestore.getInstance();
        DocumentReference documentReference = database.collection(Constants.KEY_USER_COLLECTION)
    ...
    public void onConversationClicked(UserMdl user) {
        Intent intent = new Intent(getApplicationContext(), MessagingChatActivity.class);
