...
public class Booking_ModelClass {
    ...
    String  BookDateSelected, BookEndDateSelected, RateType, ratePrice, bookingStatus, layoutAvailability, layoutName,
    ...
    public Booking_ModelClass(String bookDateSelected, String bookEndDateSelected, String rateType, String ratePrice, String bookingStatus, String layoutAvailability, String layoutName, String layoutImage, String branchImage, String branchName, Timestamp bookEndTimeSelected, Timestamp bookStartTimeSelected, Timestamp bookSubmittedDate, String customerId, String ownerId, String customerFullname, String organizationName, String numOfTenants, String customerPhoneNum, String customerEmail, String customerAddress, String proofOfPayment, String paymentOption, String bookingId, String totalPayment, String totalHours, String totalDays) {
        BookDateSelected = bookDateSelected;
        BookEndDateSelected = bookEndDateSelected;
        RateType = rateType;
    ...
    public String getBookEndDateSelected() {
        return BookEndDateSelected;
    }

    public void setBookEndDateSelected(String bookEndDateSelected) {
        BookEndDateSelected = bookEndDateSelected;
    }
